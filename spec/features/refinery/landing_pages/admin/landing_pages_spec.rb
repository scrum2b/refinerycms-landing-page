    ...
    describe "Admin" do
      describe "landing_pages" do
        ...
        describe "landing_pages list" do
          before do
            FactoryGirl.create(:landing_page, :title => "UniqueTitleOne")
            FactoryGirl.create(:landing_page, :title => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:landing_page, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:landing_page, :title => "A title") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:landing_page, :title => "UniqueTitleOne") }
